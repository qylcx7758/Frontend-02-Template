...
describe("parse html: ", function () {
    ...
    it('<a href="//time.geekbang.org"', function () {
        assert.throws(() => {
            parseHTML('<a href="//time.geekbang.org"')
        }, {
            message: "tag error"
        });
    });
    it('<a href="//time.geekbang.org"_/>', function () {
        assert.throws(() => {
            parseHTML('<a href="//time.geekbang.org"_/>')
        }, {
            message: 'unexpected charater "_"'
        });
    });
    it('<a  href="//time.geekbang.org"></a>', function () {
        let tree = parseHTML('<a  href="//time.geekbang.org"></a>');
    ...
    it('<a id="a\u0000bc"/>', function () {
        assert.throws(() => {
            ...
            message: "doubleQuotedAttributeValue error"
        });
    });
    it('<a />', function () {
    ...
    it('<a /', function () {
        assert.throws(() => {
            ...
            message: "selfClosingStartTag miss '>'"
        });
    });
    it('<a/>', function () {
        let tree = parseHTML('<a/>');
